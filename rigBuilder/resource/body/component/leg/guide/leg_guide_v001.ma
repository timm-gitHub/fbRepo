...
//Name: leg_guide_v001.ma
//Last modified: Tue, Oct 01, 2013 10:20:20 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -21.853207800527997 13.172095898043956 16.573438342112812 ;
	setAttr ".r" -type "double3" -27.938352729602816 -60.600000000000286 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.792380363353253;
...
createNode transform -n "R_noTouch_org_0" -p "rig_guide";
	setAttr ".ovdt" 2;
	setAttr ".ove" yes;
createNode transform -n "R_leg_crv_0" -p "R_noTouch_org_0";
createNode nurbsCurve -n "R_leg_crv_0Shape" -p "R_leg_crv_0";
	setAttr -k off ".v";
	setAttr -s 5 ".cp";
	setAttr ".cc" -type "nurbsCurve" 
		...
		5 0 1 2 3 4
		5
		0 7.0000000000000018 0
		0 3.5000000000000009 0
		0 0 0
		0 0 3
		0 0 6
		;
...
createNode locator -n "R_xxNAMESPACExxKnee_loc_XShape" -p "R_xxNAMESPACExxKnee_loc_X";
	setAttr -k off ".v";
createNode transform -n "R_xxNAMESPACExxAnkle_loc_X" -p "R_xxNAMESPACExxKnee_loc_X";
	addAttr -ci true -sn "order" -ln "order" -dt "string";
	addAttr -ci true -sn "secondaryAxis" -ln "secondaryAxis" -dt "string";
	addAttr -ci true -sn "label" -ln "label" -min 0 -max 29 -en "none:root:hip:knee:foot:toe:spine:neck:head:collar:shoulder:elbow:hand:finger:thumb:propA:propB:propC:other:indexfinger:middlefinger:ringfinger:pinkyfinger:extrafinger:bigtoe:indextoe:middletoe:ringtoe:pinkytoe:extratoe" 
		-at "enum";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "R_hip_ctl_0Shape.wp" "R_leg_crv_0Shape.cp[0]";
connectAttr "R_knee_ctl_0Shape.wp" "R_leg_crv_0Shape.cp[1]";
connectAttr "R_ankle_ctl_0Shape.wp" "R_leg_crv_0Shape.cp[2]";
connectAttr "R_midfoot_ctl_0Shape.wp" "R_leg_crv_0Shape.cp[3]";
connectAttr "R_toe_ctl_0Shape.wp" "R_leg_crv_0Shape.cp[4]";
...
connectAttr "R_toes_loc_X_pointConstraint1.w0" "R_toes_loc_X_pointConstraint1.tg[0].tw"
		;
connectAttr "R_legToe_loc_X.t" "R_toes_loc_X_pointConstraint1.tg[1].tt";
connectAttr "R_legToe_loc_X.rp" "R_toes_loc_X_pointConstraint1.tg[1].trp";
connectAttr "R_legToe_loc_X.rpt" "R_toes_loc_X_pointConstraint1.tg[1].trt";
connectAttr "R_legToe_loc_X.pm" "R_toes_loc_X_pointConstraint1.tg[1].tpm";
